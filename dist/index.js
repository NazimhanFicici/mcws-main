...
io.on('connection', (socket) => {
    ...
    socket.emit('minecraft_status', {
        ...
        message: connectedClients.length > 0
    ...
    socket.on('validate_pin', (data) => {
        ...
        const success = minecraftManager.sendCommand(`/scriptevent daigon:code_valid ${pinEntry.uuid}`, pinEntry.clientId);
        if (success) {
    ...
    socket.on('send_minecraft_command', (data) => {
